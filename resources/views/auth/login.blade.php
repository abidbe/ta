                    ...
                    <div class="card-body p-0 pe-lg-4 pb-lg-4 ps-lg-4 pt-lg-4">
                        <div class="row">
                            <div class="col-lg-6 d-none d-lg-flex" style="background: rgba(231,74,59,0);">
                                <div class="flex-grow-1 bg-login-image justify-content-center align-items-center" style="/*position: static;*/display: flex;"><img class="mx-3" width="326" height="293" src="{{asset('ta/assets/img/techny-business-analytics-on-tablet-screen.gif')}}" style="text-align: center;"></div>
                            </div>
                            <div class="col-md-12 col-lg-6 col-xl-6 col-xxl-6 offset-xl-0">
                                <div class="p-5">
                                    <div class="text-center"><img src="{{asset('ta/assets/img/Screenshot%202023-10-25%20221751.png')}}" style="width: 220px;"></div>
                                    <div class="text-center">
                                        <h6 class="text-dark pt-lg-0 mt-lg-4 pb-md-0 mt-xl-4 mt-sm-4 pb-sm-0 pb-0 mt-4 mb-xxl-2 mt-xxl-4 mb-2 mt-md-4 mb-lg-2 mb-xl-2 mb-sm-2 mb-md-2">Sign in to your account.</h6>
                                    </div>
