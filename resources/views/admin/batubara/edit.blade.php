                            ...
                            <div class="col form-group mb-3">
                                ...
                                <select class="form-select" aria-label="Default select example" name="data_truks_id"
                                    ...
                                    @foreach ($dataTruk as $dT)
                                        <option value="{{ $dT->id }}"
                                            {{ $batubara->data_truks_id == $dT->id ? 'selected' : '' }}>{{ $dT->nopol }}</option>
                                    @endforeach
                                </select>
                            </div>
                            <div class="col form-group mb-3">
                                <label class="form-label">Tanggal</label>
                                <input class="form-control" type="date" required placeholder="Tanggal" name="date" value="{{ $batubara->date->format('Y-m-d') }}"/>
                            </div>
                            <div class="col form-group mb-3">
                                <label class="form-label">Lokasi</label>
                                <input class="form-control" placeholder="Lokasi" name="lokasi" value="{{ $batubara->lokasi }}"/>
                            </div>

                            <div class="col form-group mb-3">
                                <label class="form-label">Driver</label>
                                <input class="form-control" name="driver" placeholder="Driver" value="{{ $batubara->driver }}">
                                </input>
                            </div>
                            <div class="col form-group mb-3">
                                <label class="form-label">Jumlah Retase</label>
                                <input class="form-control" type="number" name="jumlah_retase" placeholder="Jumlah Retase" value="{{ $batubara->jumlah_retase }}">
                                </input>
                            </div>
                            <div class="col form-group mb-3">
                                <label class="form-label">Jumlah Bucket</label>
                                <input class="form-control" type="number" name="jumlah_bucket" placeholder="Jumlah Bucket" value="{{ $batubara->jumlah_bucket }}">
                                </input>
                            </div>
                            <div class="col form-group mb-3">
                                <label class="form-label">Estimasi Tonase</label>
                                <input class="form-control" type="number" step="0.01" name="estimasi_tonase" placeholder="Estimasi Tonase" value="{{ $batubara->estimasi_tonase }}">
                                </input>
                            </div>
                            <div class="col form-group mb-3">
                                <label class="form-label">DT Gendong</label>
                                <input class="form-control" name="dt_gendong" placeholder="DT Gendong" value="{{ $batubara->dt_gendong }}">
                                </input>
                            </div>
                            <div class="col form-group mb-3">
                                <label class="form-label">Tujuan</label>
                                <input class="form-control" name="tujuan" placeholder="Tujuan" value="{{ $batubara->tujuan }}">
                                </input>
                            </div>
                        </div>
                    </div>
