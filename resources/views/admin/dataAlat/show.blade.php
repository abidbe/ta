    ...
    <div class="row justify-content-center mt-4">
        <div class="col-11 col-sm-10 col-md-8 col-lg-7 col-xl-6">
            <div class="card clean-card">
                <img class="card-img-top w-100 d-block" src="{{ asset('storage/potoAlat/' . $dataAlat->image) }}" alt="{{ $dataAlat->name }}"/>
                <div class="card-body">
                    <div class="row mb-3">
                        <div class="col">
                    ...
                    <div class="container">
                        <div class="row justify-content-center gap-2">
                            <div class="col-md-4">
                                    ...
                                    <a style="width: 100%;" href="{{ route('dataalat.edit', $dataAlat) }}" class="btn btn-success btn-block">Ubah</a>
                            ...
                            <div class="col-md-4">
                                    ...
                                    <form action="{{ route('dataalat.destroy', $dataAlat) }}" method="post">
                                        @method('DELETE')
                                        @csrf
                                        <button type="submit" class="btn btn-danger btn-block" style="width: 100%;">Hapus</button>
                                    </form>
                                
                            </div>
                            <div class="col-md-4">
                               
                                    <a style="width: 100%;" href="{{ route('dataalat.index') }}" class="btn btn-secondary btn-block">Kembali</a>
