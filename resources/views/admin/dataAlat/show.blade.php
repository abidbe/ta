                        ...
                        <div class="container">
                            <div class="row d-flex justify-content-center ">
                                <div class="row d-flex justify-content-center gap-2 ">
                                    ...
                                    <div class="row">
                                        <form class="p-0" action="{{ route('dataalat.destroy', $dataAlat) }}" method="post" id="deleteForm-{{ $dataAlat->id }}">
                                            @method('DELETE')
                                            @csrf
                                            <button type="button" class="btn btn-danger btn-block"
                                                style="width: 100%;" onclick="confirmDelete({{ $dataAlat->id }})">Hapus</button>
                                        </form>
                                    </div>
                                    <div class="row">
