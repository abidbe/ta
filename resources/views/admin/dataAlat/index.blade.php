                                ...
                                <tr>
                                    ...
                                    <td class="d-xl-flex">
                                        ...
                                        <a href="{{ route('dataalat.show', $dataAlat) }}"
                                            ...
                                            <form action="{{ route('dataalat.destroy', $dataAlat) }}" method="post" id="deleteForm-{{ $dataAlat->id }}">
                                                @method('DELETE')
                                                @csrf
                                                <button class="btn btn-danger btn-circle ms-1 delete_confirm" type="button"
                                                        style="text-align: justify;" onclick="confirmDelete({{$dataAlat->id}})">
                ...
                <div class="row">
                    <div class="col-md-6">
                        <p id="dataTable_info" class="dataTables_info" role="status" aria-live="polite">
                            Showing {{ $dataAlats->firstItem() }} to {{ $dataAlats->lastItem() }} of {{ $dataAlats->total() }} entries
                        </p>
                    </div>
